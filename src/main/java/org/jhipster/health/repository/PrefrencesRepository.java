...
public interface PrefrencesRepository extends JpaRepository<Prefrences, Long> {
    ...
    @Query(
        value = "select distinct prefrences from Prefrences prefrences left join fetch prefrences.user",
    ...
    @Query("select distinct prefrences from Prefrences prefrences left join fetch prefrences.user")
    List<Prefrences> findAllWithToOneRelationships();

    @Query("select prefrences from Prefrences prefrences left join fetch prefrences.user where prefrences.id =:id")
