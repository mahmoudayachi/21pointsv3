...
export class PrefrencesUpdateComponent implements OnInit {
  ...
  protected updateForm(prefrences: IPrefrences): void {
    ...
    this.usersSharedCollection = this.userService.addUserToCollectionIfMissing<IUser>(this.usersSharedCollection, prefrences.user);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.userService
      ...
      .pipe(map((users: IUser[]) => this.userService.addUserToCollectionIfMissing<IUser>(users, this.prefrences?.user)))
