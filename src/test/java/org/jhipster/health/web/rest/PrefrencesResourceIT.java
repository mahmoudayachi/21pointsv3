...
class PrefrencesResourceIT {
    ...
    void createPrefrences() throws Exception {
        ...
        assertThat(testPrefrences.getId()).isEqualTo(testPrefrences.getUser().getId());
    }
    ...
    @Test
    @Transactional
    void updatePrefrencesMapsIdAssociationWithNewId() throws Exception {
        ...
        assertThat(updatedPrefrences).isNotNull();
        ...
        updatedPrefrences.setUser(user);
