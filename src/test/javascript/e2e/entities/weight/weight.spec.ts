...
describe('Weight e2e test', () => {
  ...
  it('should load Weights', async () => {
    ...
    expect(await weightComponentsPage.getTitle()).to.eq('twentyonepointsv3App.weight.home.title');
  ...
  it('should load create Weight page', async () => {
    ...
    expect(await weightUpdatePage.getPageTitle()).to.eq('twentyonepointsv3App.weight.home.createOrEditLabel');
  ...
  it('should delete last Weight', async () => {
    ...
    expect(await weightDeleteDialog.getDialogTitle()).to.eq('twentyonepointsv3App.weight.delete.question');
