...
describe('Points e2e test', () => {
  ...
  it('should load Points', async () => {
    ...
    expect(await pointsComponentsPage.getTitle()).to.eq('twentyonepointsv3App.points.home.title');
  ...
  it('should load create Points page', async () => {
    ...
    expect(await pointsUpdatePage.getPageTitle()).to.eq('twentyonepointsv3App.points.home.createOrEditLabel');
  ...
  it('should delete last Points', async () => {
    ...
    expect(await pointsDeleteDialog.getDialogTitle()).to.eq('twentyonepointsv3App.points.delete.question');
